...
<main class="main">
    ...
    <section class="home section" id="home">
        <img src="{{ asset('img/home-bg.jpg') }}" alt="image" class="home__bg">
        ...
        <div class="home__container container grid">
            <div class="home__data">
                ...
                <img src="{{ asset('img/bread-1.png') }}" alt="image" class="home__bread">
            </div>

            <div class="home__image">
                <img src="{{ asset('img/home-bread.png') }}" alt="image" class="home__img">
            </div>
        ...
        <div class="new__container container grid">
            <div class="new__content grid">
                <article class="new__card">
                    ...
                    <img src="{{ asset('img/new-bread-1.png') }}" alt="img" class="new__img">
                </article>
                <article class="new__card">
                    <div class="new__data">
                    ...
                    <img src="{{ asset('img/new-bread-2.png') }}" alt="img" class="new__img">
                </article>
                <article class="new__card">
                    <div class="new__data">
                    ...
                    <img src="{{ asset('img/new-bread-3.png') }}" alt="img" class="new__img">
                </article>
            </div>
    ...
    <section class="about section" id="about">
        <div class="about__container container grid">
            <div class="about__data ">
                ...
                <img src="{{ asset('img/bread-2.png') }}" alt="image" class="about__bread">
            </div>

            <img src="{{ asset('img/about-bread.png') }}" alt="image" class="about__img">
        </div>
    </section>
    ...
    <section class="favorite section" id="favorite">
        ...
        <div class="favorite__container container grid">
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-1.png') }}" alt="image" class="favorite__img">
            ...
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-2.png') }}" alt="image" class="favorite__img">
                <div class="favorite__data">
            ...
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-3.png') }}" alt="image" class="favorite__img">
                <div class="favorite__data">
            ...
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-4.png') }}" alt="image" class="favorite__img">
                <div class="favorite__data">
            ...
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-5.png') }}" alt="image" class="favorite__img">
                <div class="favorite__data">
            ...
            <article class="favorite__card">
                <img src="{{ asset('img/favorite-bread-6.png') }}" alt="image" class="favorite__img">
                <div class="favorite__data">
    ...
    <section class="visit section" id="visit">
        <div class="visit__container">
            <img src="{{ asset('img/visit-bg.jpg') }}" alt="image" class="visit__bg">
...
<footer class="footer">
    <div class="footer__container container grid">
        ...
        <img src="{{ asset('img/bread-4.png') }}" alt="image" class="footer__img-1">
        <img src="{{ asset('img/bread-3.png') }}" alt="image" class="footer__img-2">
    </div>
